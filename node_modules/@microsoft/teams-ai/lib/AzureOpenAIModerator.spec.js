...
const AzureOpenAIModerator_1 = require("./AzureOpenAIModerator");
const TurnState_1 = require("./TurnState");
const AI_1 = require("./AI");
const AzureOpenAIPlanner_1 = require("./AzureOpenAIPlanner");
...
describe('AzureOpenAIModerator', () => {
    ...
    describe('reviewPrompt', () => {
        ...
        const planner = new AzureOpenAIPlanner_1.AzureOpenAIPlanner({
            apiKey: 'test',
        ...
        it('should return plan with action `HttpErrorActionName` when `code` >= 400', async () => {
            ...
            const moderator = new AzureOpenAIModerator_1.AzureOpenAIModerator({
                apiKey: 'test',
                moderate: 'both',
                endpoint: 'https://test'
            });
        ...
        it('should return plan with action `FlaggedInputActionName` when input is flagged', async () => {
            const result = {
                ...
                hateResult: {
                    category: 'Hate',
                    severity: OpenAIClients_1.ModerationSeverity.Medium
                },
                selfHarmResult: {
                    category: 'SelfHarm',
                    severity: OpenAIClients_1.ModerationSeverity.Safe
                },
                sexualResult: {
                    category: 'Sexual',
                    severity: OpenAIClients_1.ModerationSeverity.Safe
                ...
                violenceResult: {
                    category: 'Violence',
                    severity: OpenAIClients_1.ModerationSeverity.High
                }
            };
            (0, sinon_1.stub)(axios_1.default, 'create').returns({
                post() {
...
//# sourceMappingURL=AzureOpenAIModerator.spec.js.map