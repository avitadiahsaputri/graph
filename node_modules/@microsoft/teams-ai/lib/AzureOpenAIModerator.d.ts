...
import { CreateModerationResponseResultsInner, AzureOpenAIClient, ContentSafetyHarmCategory } from './OpenAIClients';
 ...
 */
export declare class AzureOpenAIModerator<TState extends TurnState = DefaultTurnState> extends OpenAIModerator<TState> {
     ...
     * @template TState Optional. Type of the applications turn state.
     */
    protected createModeration(input: string): Promise<CreateModerationResponseResultsInner>;
    /**
...
//# sourceMappingURL=AzureOpenAIModerator.d.ts.map